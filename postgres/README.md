...
<img src="../assets/server%20creation.png" width = "600"/></br>

Give a name to the server</br>
<img src="../assets/general.png" width = "600"/></br>
...
<img src="../assets/db.png" width = "600"/></br>
...
<ul>
  ...
  <li> In PgAdmin 4:
    <ul>
      ...
      </br><img src="../assets/createdb.png" width = "600"/></br>
      ...
      </br><img src="../assets/querytool.png" width = "600"/></br>
      <li>Click on the folder icon then on the options icon and finally click <b>Upload</b></li>
      </br><img src="../assets/options.png" width = "600"/></br>
      ...
      </br><img src="../assets/import.png" width = "600"/></br>
      ...
      </br><img src="../assets/execute.png" width = "600"/></br>
      ...
      </br><img src="../assets/importdata.png" width = "600"/></br>
      <li>Select "province.csv" file</li>
      </br><img src="../assets/select.png" width = "600"/></br>
      <li>Enable the "header" option in the Options section and set the Delimiter as comma (,)</li>
      </br><img src="../assets/importoptions.png" width = "600"/></br>
      ...
      </br><img src="../assets/selectcsv.png" width = "600"/></br>
